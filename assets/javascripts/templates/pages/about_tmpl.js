...
<div class="_table">
  <table class="_credits">
    ...
    ${credits
      .map(
        (c) =>
          `<tr><td>${c[0]}<td>&copy; ${c[1]}<td><a href=\"${c[3]}\">${c[2]}</a>`
      )
      .join("")}
  </table>
</div>
...
const credits = [
  ...
  ["Eigen3", "Eigen", "MPL2", "https://www.mozilla.org/en-US/MPL/2.0/"],
  [
    "Electron",
    "GitHub Inc.",
    "MIT",
  ...
  ["OCaml", "1995-2022 INRIA", "CC BY-SA", "https://ocaml.org/docs/"],
  [
    "Octave",
  ...
  ["SQLite", "n/a", "Public Domain", "https://sqlite.org/copyright.html"],
  [
    "Statsmodels",
